...
# GENERAL_RES = "PPO_D"
# folder_name = f"./DRL_pricing/environment/simulation_results/{GENERAL_RES}_2_4/"
# a = np.load(folder_name + "one_weight_history.npy")
# mv = np.convolve(a, np.ones(int(0.05 * e1["T"])) / int(0.05 * e1["T"]), mode='valid')
# plt.plot(mv)
# plt.show()
# print(a.tolist()[-20:])
